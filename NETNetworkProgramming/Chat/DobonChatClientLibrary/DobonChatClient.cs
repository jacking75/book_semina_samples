...
namespace Dobon.Net.Chat
{
	...
	/// </summary>
	public class DobonChatClient : TcpChatClient
	{
		#region イベント
		/// <summary>
		/// メッセージを受け取った
		...
		/// コンストラクタ
		/// </summary>
		public DobonChatClient() : base()
		{
			this._loginState = LoginState.Parted;
		}
		public DobonChatClient(Socket soc) : base(soc)
		{
			this._loginState = LoginState.Parted;
		}
		...
		protected override void OnReceivedData(ReceivedDataEventArgs e)
		{
			...
			DobonChatClient client = (DobonChatClient) e.Client;
